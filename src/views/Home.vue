      ...
      <div class="row m-rl-0 justify-content-center">
        <div class="col-md-4 p-rl-1 p-b-2">
          <div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(images/post-01.jpg);">
            <router-link :to="{name: 'blog-item'}" class="dis-block how1-child1 trans-03"></router-link>
                      ...
                      <div class="p-t-25">
                        <h5 class="p-b-5">
                          <a href="blog-detail-02.html" class="f1-m-3 cl2 hov-cl10 trans-03">
                            INE prepara censo agro-pecuário
                          </a>
                        </h5>
                        ...
                        <p class="f1-s-1 cl6 p-t-18">
                          O Instituto Nacional de Estatísticas (INE) está a preparar o Terceiro Recenseamento
                          Agro-pecuário, que deve ter lugar em 2020.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="size-w-7 w-full-sr575">
                      ...
                      <div class="p-t-10">
                        <h5 class="p-b-5">
                          <a href="blog-detail-02.html" class="f1-s-5 cl3 hov-cl10 trans-03">
                            Novo Director Nacional da Agricultura e Silvicultura quer incrementar níveis de
                            produtividade
                            no país
                          </a>
                        </h5>
                    ...
                    <div class="m-b-30">
                      ...
                      <div class="p-t-10">
                        <h5 class="p-b-5">
                          <a href="blog-detail-02.html" class="f1-s-5 cl3 hov-cl10 trans-03">
                            Em 2019, produtores de milho e mandioca passarão a ter um mercado para a sua produção
                          </a>
                        </h5>
            ...
            <div class="p-l-10 p-rl-0-sr991 p-b-20">
                  ...
                  <div class="p-tb-16 p-rl-25 bg3">
                    <h5 class="p-b-5">
                      <a href="#" class="f1-m-3 cl0 hov-cl10 trans-03">
                        Ministro da Terra em visita a Manica
                      </a>
                    </h5>
              ...
              <div class="bg10 p-rl-35 p-t-28 p-b-35 m-b-55">
                ...
                <p class="f1-s-1 cl0 p-b-25">
                  Subscreva ao nosso serviço de notificações e fique por dentro de todas as novidades agricolas.
                </p>
              ...
              <div class="col-sm-6 p-r-25 p-r-15-sr991">
                ...
                <div class="m-b-45">
                  ...
                  <div class="p-t-16">
                    <h5 class="p-b-5">
                      <a href="blog-detail-01.html" class="f1-m-3 cl2 hov-cl10 trans-03">
                        Producao suina em alta em Chibabava
                      </a>
                    </h5>
          ...
          <div class="col-md-10 col-lg-4">
            <div class="p-l-10 p-rl-0-sr991 p-b-20">
              ...
              <div class="p-b-55">
                ...
                <div>
                  ...
                  <div class="p-tb-16 p-rl-25 bg3">
                    <h5 class="p-b-5">
                      <a href="#" class="f1-m-3 cl0 hov-cl10 trans-03">
                        Celso Correia fala sobre a importancia do sector agrario na economia
                      </a>
                    </h5>
              ...
              <!-- <div class="bg10 p-rl-35 p-t-28 p-b-35 m-b-55">
                ...
                <p class="f1-s-1 cl0 p-b-25">
                  Tenha todo os nosso conteudos por email e numa base semanal.
                </p>
